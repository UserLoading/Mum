...
public class Login extends javax.swing.JFrame {
    ...
    public static String UserName = "j";
    public static String  Password = "j";
    public static int AttemptsAllowed = 4;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Attempts++;
        if (UserName.contains(jTextField1.toString())&& Password.contains(jPasswordField1.toString())){
            //Place programm name here 
        }
        if (Attempts==AttemptsAllowed){
            ...
            jLabel5.setText(String.valueOf(Attempts));
        }
